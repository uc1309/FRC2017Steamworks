...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		//MjpegServer 1 from USB Camera 0
		new Thread(() -> {
		...
		// UsbCamera camera2 = CameraServer.getInstance().startAutomaticCapture("Camera 2", 1);
		/* SmartDashboard.putString("Camera 1 Path", camera1.getPath());
		CvSink cvSink = CameraServer.getInstance().getVideo(camera1);
		CvSource outputStream = CameraServer.getInstance().putVideo("Exposure", 640, 480); */
